...
import GestionareSuprafete from './GestionareSuprafete';
    ...
    <div className="container">
      ...
      <div className="content">
        <Routes>
          ...
          <Route path="/admin/gestionare-suprafete" element={isAuthenticated ? <GestionareSuprafete /> : <Navigate to="/admin" />} />
        </Routes>
      </div>
    </div>
  );
